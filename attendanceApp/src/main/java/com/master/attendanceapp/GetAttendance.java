...
public class GetAttendance extends Activity implements OnClickListener {
	...
	public void onClick(View v) {
		...
		case R.id.semGo:
			...
			try {
				...
				Intent semi = new Intent(this, CheckAttendanceBySem.class);
				semi.putExtras(b1);
				startActivity(semi);
			} catch (Exception e) {
		...
		case R.id.idGo:
			...
			try {
				...
				Bundle b = new Bundle();
				b.putInt("id", id);
				Intent idGo = new Intent(this, CheckAttendanceByID.class);
				idGo.putExtras(b);
				startActivity(idGo);
			} catch (Exception e) {
				// TODO: handle exception
